...
const PopoverContent = ({
  ...
  <RadixPopover.Content
    ref={ref}
    className={cx(
      "relative overflow-hidden rounded-sm bg-background-offset dark:bg-background-100 shadow-modal shadow-black/10 duration-100 origin-rdx-popover rdx-state-closed:animate-[dialog-out_150ms_cubic-bezier(0.33,1,0.68,1)] rdx-state-open:animate-[dialog-in_150ms_cubic-bezier(0.33,1,0.68,1)] dark:border dark:border-background-offset",
      className
    )}
    {...props}
  >
