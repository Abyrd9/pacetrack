...
const TooltipContent = ({
  ...
  <RadixTooltip.Content
    ref={ref}
    className={cx(
      "relative rounded-sm bg-background border border-background-100 shadow-modal shadow-black/5 origin-rdx-tooltip rdx-state-delayed-open:animate-[fade-up_100ms_cubic-bezier(0.33,1,0.68,1)] rdx-state-instant-open:animate-[fade-up_100ms_cubic-bezier(0.33,1,0.68,1)]",
      className
    )}
    {...props}
  >
