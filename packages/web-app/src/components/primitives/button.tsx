...
export const buttonBaseStyles = tv({
  base: "relative h-fit overflow-hidden whitespace-nowrap rounded-md py-1.5 outline-hidden select-none px-2.5 flex items-center justify-center text-foreground transition-colors duration-75",
  variants: {
    kind: {
      default: "",
      icon: "",
  ...
  compoundVariants: [
    ...
    },
    {
      kind: "icon",
      size: "xs",
      class: "h-6 w-6 min-w-6 min-h-6 p-1 text-xs",
    },
    {
      kind: "icon",
      size: "xss",
      class: "h-5 w-5 min-w-5 min-h-5 p-1 text-[10px]",
    },
  ],
  defaultVariants: {
    size: "default",
